...
return (
    <div className="w-full border-y border-black mt-1 pt-5">
      <div className="ml-5">
          ...
          <div className="w-2/4 px-5 pb-5">
              <div className="border-t border-dotted border-[color:var(--color-primary)] py-5 flex flex-row">
                ...
                <div className="w-1/2">
                  ...
                  <p
                    className="text-[color:var(--color-black500)] text-sm text-left font-vollkorn"
                    dangerouslySetInnerHTML={{ __html: secondPost.excerpt.rendered }}
                  />
                </div>
              </div> 
              <div className="border-t border-dotted border-[color:var(--color-primary)] py-5 flex flex-row">
